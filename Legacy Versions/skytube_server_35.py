...
function PostCard(props) {
  ...
  return html`<div
    ...
    <div style=${{padding:'18px 24px'}}>
      ...
      <!-- Actions -->
      <div style=${{display:'flex',alignItems:'center',gap:16,marginTop:12}} onClick=${function(e){e.stopPropagation();}}>
        ...
        <div onClick=${function(e){e.stopPropagation();}}>
          <${SubscribeButton} did=${author.did} viewer=${author.viewer} session=${sess} small=${false}/>
        </div>
        <span style=${{color:'#444',fontSize:13,display:'flex',alignItems:'center',gap:6,marginLeft:'auto'}}>
