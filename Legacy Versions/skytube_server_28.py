...
function VideoGrid(props) {
  ...
  // Reset when the video list changes
  useEffect(function() { setVisible(GRID_PAGE); }, [props.videos]);

  function loadMore() {
    setVisible(function(v) { return Math.min(v + GRID_PAGE, videos.length); });
  }

  // IntersectionObserver auto-trigger (best-effort; button is the reliable fallback)
  useEffect(function() {
