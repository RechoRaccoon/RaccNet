...
(function(){
  try{
    ...
    if(bg){
      ...
      bgEl.id='raccnet-bg';
      bgEl.style.cssText='position:fixed;top:0;left:0;right:0;bottom:0;z-index:-1;pointer-events:none;background-size:cover;background-position:center;background-attachment:fixed;background-image:url('+bg+');opacity:0.25;';
